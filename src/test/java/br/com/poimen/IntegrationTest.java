...
import br.com.poimen.config.TestSecurityConfiguration;
...
@SpringBootTest(classes = { PoimenApp.class, JacksonConfiguration.class, AsyncSyncConfiguration.class, TestSecurityConfiguration.class })
