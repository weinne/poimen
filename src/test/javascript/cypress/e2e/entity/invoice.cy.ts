...
describe('Invoice e2e test', () => {
  ...
  const invoiceSample = { number: 'whenever stunning poppy', issueDate: '2024-12-18T11:54:25.646Z', totalAmount: 12593.97, type: 'late' };
  ...
  describe('new Invoice page', () => {
    ...
    it('should create an instance of Invoice', () => {
      cy.get(`[data-cy="number"]`).type('digit instead meanwhile');
      cy.get(`[data-cy="number"]`).should('have.value', 'digit instead meanwhile');

      cy.get(`[data-cy="issueDate"]`).type('2024-12-18T13:09');
      cy.get(`[data-cy="issueDate"]`).blur();
      cy.get(`[data-cy="issueDate"]`).should('have.value', '2024-12-18T13:09');

      cy.get(`[data-cy="totalAmount"]`).type('31881.92');
      cy.get(`[data-cy="totalAmount"]`).should('have.value', '31881.92');

      cy.get(`[data-cy="type"]`).type('whose');
      cy.get(`[data-cy="type"]`).should('have.value', 'whose');

      cy.get(`[data-cy="supplier"]`).type('amidst athwart individual');
      cy.get(`[data-cy="supplier"]`).should('have.value', 'amidst athwart individual');

      cy.setFieldImageAsBytesOfEntity('invoiceFile', 'integration-test.png', 'image/png');
