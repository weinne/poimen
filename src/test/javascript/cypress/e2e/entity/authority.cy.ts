...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: 'c901492b-679d-4161-94a0-f01001789cef' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('2656cbf9-e422-425b-bd30-efb15a2c22c0');
      cy.get(`[data-cy="name"]`).should('have.value', '2656cbf9-e422-425b-bd30-efb15a2c22c0');
