...
import { sampleWithRequiredData } from '../counseling-session.test-samples';
...
describe('CounselingSession Management Component', () => {
  let comp: CounselingSessionComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [CounselingSessionComponent],
      providers: [
        provideHttpClient(),
        {
      ...
      .overrideTemplate(CounselingSessionComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.counselingSessions?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to counselingSessionService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getCounselingSessionIdentifier');
      const id = comp.trackId(entity);
      expect(service.getCounselingSessionIdentifier).toHaveBeenCalledWith(entity);
