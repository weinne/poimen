...
public class MinistryGroupTestSamples {
    ...
    public static MinistryGroup getMinistryGroupSample1() {
        return new MinistryGroup().id(1L).name("name1").description("description1").leader("leader1");
    }

    public static MinistryGroup getMinistryGroupSample2() {
        return new MinistryGroup().id(2L).name("name2").description("description2").leader("leader2");
    }
