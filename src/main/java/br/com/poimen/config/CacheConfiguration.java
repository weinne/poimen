...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, br.com.poimen.domain.ApplicationUser.class.getName());
            createCache(cm, br.com.poimen.domain.Appointment.class.getName());
            ...
            createCache(cm, br.com.poimen.domain.Church.class.getName() + ".subscriptions");
            ...
            createCache(cm, br.com.poimen.domain.Church.class.getName() + ".appointments");
            ...
            createCache(cm, br.com.poimen.domain.CounselingSession.class.getName() + ".appointments");
            createCache(cm, br.com.poimen.domain.Hymn.class.getName());
            createCache(cm, br.com.poimen.domain.Hymn.class.getName() + ".services");
            createCache(cm, br.com.poimen.domain.Invoice.class.getName());
            createCache(cm, br.com.poimen.domain.Member.class.getName());
            createCache(cm, br.com.poimen.domain.Member.class.getName() + ".counselings");
            createCache(cm, br.com.poimen.domain.Member.class.getName() + ".tasks");
            createCache(cm, br.com.poimen.domain.Member.class.getName() + ".preachIns");
            createCache(cm, br.com.poimen.domain.Member.class.getName() + ".liturgyIns");
            createCache(cm, br.com.poimen.domain.Member.class.getName() + ".appointments");
            createCache(cm, br.com.poimen.domain.Member.class.getName() + ".presidentOfs");
            createCache(cm, br.com.poimen.domain.Member.class.getName() + ".supervisorOfs");
            createCache(cm, br.com.poimen.domain.Member.class.getName() + ".playIns");
            createCache(cm, br.com.poimen.domain.Member.class.getName() + ".participateIns");
            createCache(cm, br.com.poimen.domain.Member.class.getName() + ".memberOfs");
            createCache(cm, br.com.poimen.domain.MinistryGroup.class.getName());
            createCache(cm, br.com.poimen.domain.MinistryGroup.class.getName() + ".members");
            createCache(cm, br.com.poimen.domain.MinistryGroup.class.getName() + ".appointments");
            createCache(cm, br.com.poimen.domain.Plan.class.getName());
            createCache(cm, br.com.poimen.domain.Plan.class.getName() + ".subscriptions");
            ...
            createCache(cm, br.com.poimen.domain.WorshipEvent.class.getName() + ".participants");
            createCache(cm, br.com.poimen.domain.WorshipEvent.class.getName() + ".appointments");
